...
public class Timex3_Type extends Annotation_Type {
  ...
  /** @generated */
  final Feature casFeat_Timex3;
  /** @generated */
  final int     casFeatCode_Timex3;
  /** @generated */ 
  ...
  public Timex3_Type(JCas jcas, Type casType) {
    ...
    casFeat_Timex3 = jcas.getRequiredFeatureDE(casType, "Timex3", "uima.cas.String", featOkTst);
    casFeatCode_Timex3  = (null == casFeat_Timex3) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_Timex3).getCode();
