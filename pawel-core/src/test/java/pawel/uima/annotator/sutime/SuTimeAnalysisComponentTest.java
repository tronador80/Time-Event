...
public class SuTimeAnalysisComponentTest {
	...
	public void testSuTime() {
		SuTimeAnalysisComponent sutac = new SuTimeAnalysisComponent();
		...
		try {
			result = sutac.tagTime(exampleInput);
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 */
	@Test
	public void testSuTimeWithTimeStamp() {
		SuTimeAnalysisComponent sutac = new SuTimeAnalysisComponent();

		String exampleInput = "[{\"annotations\":[{\"Text\":\"Tomorrow I go to school.\",\"begin\":\"0\",\"date\":\"201307130000\",\"end\":\"0\"},{\"Sentence\":\"Tomorrow I go to school.\",\"begin\":\"0\",\"end\":\"24\",\"sentenceIndex\":\"0\",\"tokenBegin\":\"0\",\"tokenEnd\":\"6\"},{\"Token\":\"Tomorrow\",\"afterToken\":\" \",\"beforeToken\":\"\",\"begin\":\"0\",\"end\":\"8\",\"originalText\":\"Tomorrow\",\"pos\":\"NN\",\"value\":\"Tomorrow\"},{\"Token\":\"I\",\"afterToken\":\" \",\"beforeToken\":\" \",\"begin\":\"9\",\"end\":\"10\",\"originalText\":\"I\",\"pos\":\"PRP\",\"value\":\"I\"},{\"Token\":\"go\",\"afterToken\":\" \",\"beforeToken\":\" \",\"begin\":\"11\",\"end\":\"13\",\"originalText\":\"go\",\"pos\":\"VBP\",\"value\":\"go\"},{\"Token\":\"to\",\"afterToken\":\" \",\"beforeToken\":\" \",\"begin\":\"14\",\"end\":\"16\",\"originalText\":\"to\",\"pos\":\"TO\",\"value\":\"to\"},{\"Token\":\"school\",\"afterToken\":\"\",\"beforeToken\":\" \",\"begin\":\"17\",\"end\":\"23\",\"originalText\":\"school\",\"pos\":\"NN\",\"value\":\"school\"},{\"Token\":\".\",\"afterToken\":\"\",\"beforeToken\":\"\",\"begin\":\"23\",\"end\":\"24\",\"originalText\":\".\",\"pos\":\".\",\"value\":\".\"}]}]";
		...
		List<String> expectedTimexAnnotations = new ArrayList<String>();
		expectedTimexAnnotations.add("2013-07-14T00:00");
