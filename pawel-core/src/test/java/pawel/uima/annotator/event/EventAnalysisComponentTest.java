...
public class EventAnalysisComponentTest {
	...
	public void testTagEventOlder() {
		...
		try {
			result = eac.tagEvent(exampleInput, 250, 10, false);
		} catch (Exception e) {
			e.printStackTrace();
	...
	@Test
	public void testTagEventOlderWithTimespan() {
		EventAnalysisComponent eac = new EventAnalysisComponent();
	...
	public void testTagEventNewer() {
		...
		IJsonNode result = null;
		try {
			result = eac.tagEvent(exampleInput, 250, 10, true);
		} catch (Exception e) {
			e.printStackTrace();
			Assert.fail(e.getMessage());
		}
		...
		List<String> expectedEventStartTime = new ArrayList<String>();
		expectedEventStartTime.add("584748000000");
		expectedEventStartTime.add("1380405600000");

		List<String> expectedEventEndTime = new ArrayList<String>();
		expectedEventEndTime.add("584834399000");
		expectedEventEndTime.add("1380491999000");
	...
	@Test
	public void testTagEventNewerWithTimespan() {
		EventAnalysisComponent eac = new EventAnalysisComponent();
		...
		Assert.assertTrue(expectedEventContents.remove(eventObject.get("event")
				.toString()));
		Assert.assertTrue(eventObject.get("is_timespan").toString()
				.equals("true"));
	}
}
